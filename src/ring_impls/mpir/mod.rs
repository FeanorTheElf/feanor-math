...
impl MPZEl {
    ...
    pub fn assign(&mut self, rhs: &MPZEl) {
        unsafe {
            mpir_bindings::__gmpz_set(
                &mut self.integer as mpir_bindings::mpz_ptr,
...
impl MPZBase {
    ...
    pub fn from_le_bytes(&self, dst: &mut MPZEl, input: &[u8]) {
        unsafe {
            assert_eq!(
                std::mem::size_of::<mpir_bindings::mpir_ui>(),
                std::mem::size_of::<u64>()
            );
            if input.len() == 0 {
    ...
    pub fn abs_base_u64_repr_len(&self, src: &MPZEl) -> usize {
        self.abs_highest_set_bit(src)
            .map(|n| (n / u64::BITS as usize) + 1)
            .unwrap_or(0)
    }
...
impl RingBase for MPZBase {
    ...
    fn clone_el(&self, val: &Self::Element) -> Self::Element {
        unsafe {
            ...
            mpir_bindings::__gmpz_set(
                ...
                &val.integer as mpir_bindings::mpz_srcptr,
            );
            return result;
        }
    }
    ...
    fn sub_ref_fst(&self, lhs: &Self::Element, mut rhs: Self::Element) -> Self::Element {
        unsafe {
            mpir_bindings::__gmpz_sub(
                &mut rhs.integer as mpir_bindings::mpz_ptr,
                &lhs.integer as mpir_bindings::mpz_srcptr,
                &rhs.integer as mpir_bindings::mpz_srcptr,
            );
            return rhs;
    ...
    fn is_zero(&self, val: &Self::Element) -> bool {
        unsafe { mpir_bindings::__gmpz_cmp_si(&val.integer as mpir_bindings::mpz_srcptr, 0) == 0 }
    }
...
impl OrderedRing for MPZBase {
    ...
    fn is_neg(&self, value: &Self::Element) -> bool {
        unsafe { mpir_bindings::mpz_is_neg(&value.integer as mpir_bindings::mpz_srcptr) }
    }
}
...
impl EuclideanRing for MPZBase {
    ...
    fn euclidean_deg(&self, val: &Self::Element) -> Option<usize> {
        if self.abs_highest_set_bit(val).unwrap_or(0) < usize::BITS as usize {
            unsafe {
                mpir_bindings::__gmpz_get_ui(&val.integer as mpir_bindings::mpz_srcptr)
                    .try_into()
                    .ok()
            }
        } else {
...
impl IntegerRing for MPZBase {
    fn to_float_approx(&self, el: &Self::Element) -> f64 {
        unsafe { mpir_bindings::__gmpz_get_d(&el.integer as mpir_bindings::mpz_srcptr) }
    }
    ...
    fn mul_pow_2(&self, el: &mut Self::Element, power: usize) {
        unsafe {
            mpir_bindings::__gmpz_mul_2exp(
                &mut el.integer as mpir_bindings::mpz_ptr,
    ...
    fn euclidean_div_pow_2(&self, el: &mut Self::Element, power: usize) {
        unsafe {
            mpir_bindings::__gmpz_tdiv_q_2exp(
                &mut el.integer as mpir_bindings::mpz_ptr,
                &el.integer as mpir_bindings::mpz_srcptr,
                power as u64,
            )
...
impl_poly_gcd_locally_for_ZZ! { IntegerPolyLiftFactorsDomain for MPZBase }
...
impl HashableElRing for MPZBase {
    fn hash<H: std::hash::Hasher>(&self, el: &Self::Element, h: &mut H) {
        unsafe {
            <_ as std::hash::Hash>::hash(
                &(
                    self.is_neg(&el),
                    self.abs_highest_set_bit(&el),
                    mpir_bindings::__gmpz_get_ui(&el.integer as mpir_bindings::mpz_srcptr),
                ),
                h,
            )
        }
...
impl IntCast<RustBigintRingBase> for MPZBase {
    fn cast(&self, _: &RustBigintRingBase, el: RustBigint) -> Self::Element {
        let mut result = MPZEl::new();
        self.from_base_u64_repr(
            &mut result,
            &RustBigintRing::RING
                .get_ring()
                .abs_base_u64_repr(&el)
                .collect::<Vec<_>>()[..],
        );
        ...
        $(
            impl IntCast<StaticRingBase<$from>> for MPZBase {
                ...
                fn cast(&self, _: &StaticRingBase<$from>, el: $from) -> MPZEl {
                    int_cast(el.try_into().unwrap(), &RingRef::new(self), ZZi64)
                }
            }
            ...
            impl IntCast<MPZBase> for StaticRingBase<$from> {
                ...
                fn cast(&self, _: &MPZBase, el: MPZEl) -> $from {
                    int_cast(el, &ZZi64, &MPZ::RING) as $from
                }
            }
        )*
    }
...
fn test_divisibility_ring_axioms() {
    feanor_tracing::DelayedLogger::init_test();
    crate::ring_properties::divisibility::generic_tests::test_divisibility_axioms(MPZ::RING, edge_case_elements())
}

#[test]
fn test_euclidean_ring_axioms() {
    feanor_tracing::DelayedLogger::init_test();
    crate::ring_properties::pid::generic_tests::test_euclidean_ring_axioms(MPZ::RING, edge_case_elements())
}

#[test]
fn test_integer_ring_axioms() {
    feanor_tracing::DelayedLogger::init_test();
    crate::ring_properties::integer::generic_tests::test_integer_axioms(MPZ::RING, edge_case_elements())
}
...
fn test_canonical_iso_axioms_i32() {
    ...
    crate::ring::generic_tests::test_hom_axioms(
        StaticRing::<i32>::RING,
        MPZ::RING,
        [0, -1, 1, i16::MAX as i32, i16::MIN as i32].into_iter(),
    );
    crate::ring::generic_tests::test_iso_axioms(
        StaticRing::<i32>::RING,
        MPZ::RING,
        [0, -1, 1, i16::MIN as i32, i16::MAX as i32].into_iter(),
    );
}
...
fn test_canonical_iso_axioms_i64() {
    ...
    crate::ring::generic_tests::test_hom_axioms(
        ZZi64,
        MPZ::RING,
        [0, -1, 1, i32::MAX as i64, i32::MIN as i64].into_iter(),
    );
    crate::ring::generic_tests::test_iso_axioms(
        ZZi64,
        MPZ::RING,
        [0, -1, 1, i32::MIN as i64, i32::MAX as i64].into_iter(),
    );

    assert_el_eq!(
        MPZ::RING,
        MPZ::RING.sub(MPZ::RING.power_of_two(63), MPZ::RING.one()),
        &MPZ::RING.coerce(&ZZi64, i64::MAX)
    );
    assert_el_eq!(
        MPZ::RING,
        MPZ::RING.negate(MPZ::RING.power_of_two(63)),
        MPZ::RING.coerce(&ZZi64, i64::MIN)
    );
    assert_eq!(
        i64::MAX,
        int_cast(
...
fn test_canonical_iso_axioms_i128() {
    ...
    crate::ring::generic_tests::test_hom_axioms(
        ...
        MPZ::RING,
        [0, -1, 1, i64::MAX as i128, i64::MIN as i128].into_iter(),
    );
    crate::ring::generic_tests::test_iso_axioms(
        StaticRing::<i128>::RING,
        MPZ::RING,
        [0, -1, 1, i64::MIN as i128, i64::MAX as i128].into_iter(),
    );

    assert_el_eq!(
        MPZ::RING,
        MPZ::RING.sub(MPZ::RING.power_of_two(127), MPZ::RING.one()),
        &MPZ::RING.coerce(&StaticRing::<i128>::RING, i128::MAX)
    );
    assert_el_eq!(
        MPZ::RING,
        MPZ::RING.negate(MPZ::RING.power_of_two(127)),
        MPZ::RING.coerce(&StaticRing::<i128>::RING, i128::MIN)
    );
    assert_eq!(
        i128::MAX,
        int_cast(
...
fn test_serialization() {
    feanor_tracing::DelayedLogger::init_test();
    crate::ring_properties::serialization::generic_tests::test_serialization(MPZ::RING, edge_case_elements());
}
