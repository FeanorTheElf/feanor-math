...
use crate::ring_impls::extension::MonogenicExtension;
...
impl<R> MonogenicExtension for R
where
    R: DelegateRing,
    <R as DelegateRing>::Base: MonogenicExtension,
{
    type VectorRepresentation<'a>
        = <<R as DelegateRing>::Base as MonogenicExtension>::VectorRepresentation<'a>
    where
        Self: 'a;
