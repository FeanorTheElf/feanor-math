...
where
    H: Homomorphism<Complex64Base, Complex64Base> + Clone,
    A: Allocator + Clone,
{
    ...
    pub fn for_complex_with_hom(hom: H, n: usize, tmp_mem_allocator: A) -> Self {
        ...
        Self::new_with_pows_with_hom(
            hom,
            |x| CC.root_of_unity(x, 2 * n_i64),
            |x| CC.root_of_unity(x, 1 << log2_m),
            n,
            log2_m,
            tmp_mem_allocator,
        )
    ...
    A: Allocator + Clone,
{
    ...
    pub fn new(
        ring: R,
        root_of_unity_2n: El<R>,
        root_of_unity_m: El<R>,
        n: usize,
        log2_m: usize,
        tmp_mem_allocator: A,
    ) -> Self {
    ...
    pub fn new_with_pows<F, G>(
        ring: R,
        root_of_unity_2n_pows: F,
        root_of_unity_m_pows: G,
        n: usize,
        log2_m: usize,
        tmp_mem_allocator: A,
    ) -> Self
    ...
    A: Allocator + Clone,
{
    ...
    pub fn new_with_hom(
        ...
        root_of_unity_m: R_twiddle::Element,
        n: usize,
        log2_m: usize,
        tmp_mem_allocator: A,
    ) -> Self {
    ...
    ///
    /// This function takes a length-`m` base FFT, where `m >= 2m`, and a function
    ...
    A: Allocator + Clone,
{
    fn expected_absolute_error(&self, input_bound: f64, input_error: f64) -> f64 {
        ...
        let error_after_mul = new_input_bound * b_bitreverse_fft_error
            + b_bitreverse_fft_bound * error_after_fft
            + f64::EPSILON * new_input_bound * b_bitreverse_fft_bound;
        let error_after_inv_fft = self
            .m_fft_table
