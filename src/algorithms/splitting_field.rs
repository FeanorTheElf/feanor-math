...
pub trait PerfectField: SelfIso + Field + SpecializeToFiniteField + SpecializeToFiniteRing + InterpolationBaseRing {}
...
impl<R> PerfectField for R
    where R: FreeAlgebra + Field + SpecializeToFiniteField + SpecializeToFiniteRing + InterpolationBaseRing,
