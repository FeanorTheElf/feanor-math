...
/// [`FreeAlgebraImplBase`].
pub type FreeAlgebraImpl<R, V, C = DynConvolution<'static, <R as RingStore>::Type>, A = Global> =
    ...
    C: ConvolutionAlgorithm<R::Type>,
{
    ...
    pub fn new_with_convolution(
        ...
        RingValue::from(FreeAlgebraImplBase::create(
            base_ring,
            rank,
            x_pow_rank,
            gen_name,
    ...
    C: ConvolutionAlgorithm<R::Type>,
{
    ...
    #[stability::unstable(feature = "enable")]
    pub fn gen_name(&self) -> &'static str { self.gen_name }
