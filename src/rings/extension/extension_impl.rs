...
/// 
/// Soon to be replaced by [`crate::rings::extension::impl_short::FreeAlgebraImpl`] since this is faster
/// if the underlying modulus is sparse in a certain (common) way.
/// 
/// # Example
/// ```
