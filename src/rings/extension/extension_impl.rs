    ...
    C: ConvolutionAlgorithm<R::Type>,
{
    ...
    fn fma(&self, lhs: &Self::Element, rhs: &Self::Element, summand: Self::Element) -> Self::Element {
        ...
        self.convolution
            .compute_convolution(&lhs.values[..], &rhs.values[..], &mut tmp[..], self.base_ring());
    ...
    fn square(&self, value: &mut Self::Element) {
        ...
        let x_prepared =
            self.convolution
                .prepare_convolution_operand(&value.values[..], Some(2 * self.rank()), self.base_ring());
    ...
    C: ConvolutionAlgorithm<R::Type>,
{
    ...
    extern "rust-call" fn call_once(mut self, args: (&'b [El<R>],)) -> Self::Output { self.call_mut(args) }
}
    ...
    C: ConvolutionAlgorithm<R::Type>,
{
    extern "rust-call" fn call_mut(&mut self, args: (&'b [El<R>],)) -> Self::Output {
        self.base_ring
            .from_canonical_basis(args.0.iter().map(|x| self.base_ring.base_ring().clone_el(x)))
    }
}
